...
--
-- Host: muscat-dev.cro2kqu2go52.eu-north-1.rds.amazonaws.com
-- Generation Time: Mar 11, 2024 at 09:42 AM
...
INSERT INTO `user` (`user_id`, `user_email`, `user_password`, `user_type`, `company_name`, `register_num`, `company_address`, `manager_name`, `manager_phone`, `manager_depart`, `manager_grade`, `other`, `approval`, `nickname`, `admin_name`, `admin_phone`, `code`, `updated_time`) VALUES
(1, 'test', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(2, 'string', 'ecb252044b5ea0f679ee78ec1a12904739e2904d', 1, 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 1, 'string', 'string', 'string', NULL, NULL),
(3, 'ayong19910110@gmail.com', '86f7e437faa5a7fce15d1ddcb9eaeaea377667b8', 0, NULL, '', '', '', '', '', '', '', 0, 'SupperAdmin', '', '', '71314672', '2024-03-10 03:30:10');
